...
(function($PS) {
  ...
  var showJsonDecodeError = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Data.Codec.Argonaut (line 73, column 10 - line 79, column 35): " + [ v.constructor.name ]);
      }
  };
  var jsonPrimCodec = function (ty) {
      return function (f) {
          return Data_Codec.basicCodec((function () {
              var $185 = Data_Maybe.maybe(new Data_Either.Left(new TypeMismatch(ty)))(Control_Applicative.pure(Data_Either.applicativeEither));
              return function ($186) {
                  return $185(f($186));
              };
          })());
  ...
  var jarray = jsonPrimCodec("Array")(Data_Argonaut_Core.toArray)(Data_Argonaut_Core.fromArray);         
  var array = function (codec) {
      var enc = function (xs) {
          return Control_Monad_Writer.writer(new Data_Tuple.Tuple(xs, Data_Argonaut_Core.fromArray(Data_Functor.map(Data_Functor.functorArray)(Data_Codec.encode(codec))(xs))));
      };
      var dec = function (j) {
          return Control_Bind.bindFlipped(Data_Either.bindEither)((function () {
              var $200 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(function (v) {
                  return Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(AtIndex.create(v.value0))(Data_Codec.decode(codec)(v.value1));
              });
              var $201 = Data_Array.mapWithIndex(Data_Tuple.Tuple.create);
              return function ($202) {
                  return $200($201($202));
              };
...
(function($PS) {
  ...
  var SetFilterString = (function () {
      function SetFilterString(value0) {
          this.value0 = value0;
      };
      SetFilterString.create = function (value0) {
          return new SetFilterString(value0);
      };
      return SetFilterString;
  })();
  var matchFilter = function (filter) {
      return function (str) {
          var matchString = function (q) {
              return Data_String_CodeUnits.contains(q)(str);
          };
          return Data_Array.all(matchString)(Data_String_Common.split(" ")(Data_String_Common.trim(filter)));
      };
  };
  var decodeStringArray = Data_Codec.decode(Data_Codec_Argonaut.array(Data_Codec_Argonaut.string));
  var fetchRoutes = Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)("/json/paths.json"))(function (res) {
      if (res instanceof Data_Either.Left) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("failed: " + Affjax.printError(res.value0)))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Maybe.Nothing.value);
          });
      };
      if (res instanceof Data_Either.Right) {
          var routes = decodeStringArray(res.value0.body);
          if (routes instanceof Data_Either.Left) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("failed: " + Data_Show.show(Data_Codec_Argonaut.showJsonDecodeError)(routes.value0)))(function () {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Maybe.Nothing.value);
              });
          };
          if (routes instanceof Data_Either.Right) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Maybe.Just(routes.value0));
          };
          throw new Error("Failed pattern match at Main (line 40, column 7 - line 44, column 38): " + [ routes.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main (line 34, column 3 - line 44, column 38): " + [ res.constructor.name ]);
  });
  var component = function (dictMonadAff) {
      ...
      var renderFilter = function (str) {
          return Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_("routes-filter-input"), Halogen_HTML_Events.onValueInput(function (e) {
              return new SetFilterString(e);
          }), Halogen_HTML_Properties.value(str), Halogen_HTML_Properties.placeholder("search") ]);
      };
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ renderFilter(state.filter), renderRoutes(Data_Array.filter(matchFilter(state.filter))(state.routes)) ]);
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffAff)(fetchRoutes))(function (routes) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#halogen-routes"))(function (elem) {
              var tgt = Data_Maybe.fromMaybe(body)(elem);
              return Halogen_VDom_Driver.runUI(component(Effect_Aff_Class.monadAffAff))({
                  routes: Data_Maybe.fromMaybe([  ])(routes)
              })(tgt);
          });
      });
  }));
  ...
  exports["main"] = main;
  exports["SetFilterString"] = SetFilterString;
  exports["Query"] = Query;
