...
(function($PS) {
  ...
  var fetchRoutes = Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)("/json/paths.json"))(function (res) {
      ...
      if (res instanceof Data_Either.Right) {
          ...
          throw new Error("Failed pattern match at Main (line 37, column 7 - line 41, column 38): " + [ routes.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main (line 31, column 3 - line 41, column 38): " + [ res.constructor.name ]);
  });
  var component = function (dictMonadAff) {
      ...
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ renderRoutes(state.routes) ]);
      };
